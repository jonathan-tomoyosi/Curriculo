 ...
 * Ícones de marca.
 *
 * O lucide-react removeu os ícones de marca a partir da v1, então GitHub e LinkedIn
 * ficam aqui como SVG próprio (traçados do Simple Icons, CC0). Mesma assinatura dos
 * ícones do lucide — `className` controla tamanho e cor — para o uso ser idêntico.
 */
